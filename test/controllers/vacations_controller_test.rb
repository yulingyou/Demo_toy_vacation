...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { approval: @vacation.approval, content: @vacation.content, vacation_type: @vacation.vacation_type } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { approval: @vacation.approval, content: @vacation.content, vacation_type: @vacation.vacation_type } }
